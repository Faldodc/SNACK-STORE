...
public class GUISnackLocal extends javax.swing.JFrame {
    ...
    private void btnBeliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBeliActionPerformed
        ...
        try {
            ...
            // Harga berdasarkan snack lokal
            double harga = switch (snack) {
                case "Keripik Tempe" -> 5000;
                case "Bakpia Pathok" -> 7000;
                case "Rengginang" -> 5500;
                case "Rempeyek" -> 6000;
                case "Kacang Garing" -> 4500;
                default -> 0;
            };

            double total = harga * jumlah;
            if (promo) total *= 0.85;  // Diskon promo 15%
            if (tipePembeli.equals("Member")) total *= 0.9;  // Diskon member 10%
